...
import type { SnapshotRenderer } from '@playwright/trace-viewer/src/sw/snapshotRenderer';
import { SnapshotStorage } from '@playwright/trace-viewer/src/sw/snapshotStorage';
