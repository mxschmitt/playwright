...
exports.addCustomEqualityTesters = exports.getCustomEqualityTesters = exports.setMatchers = exports.getMatchers = exports.setState = exports.getState = exports.INTERNAL_MATCHER_FLAG = void 0;
...
exports.INTERNAL_MATCHER_FLAG = Symbol.for('$$jest-internal-matcher');
...
const setMatchers = (matchers, isInternal, expect) => {
    Object.keys(matchers).forEach(key => {
        ...
        if (typeof matcher !== 'function') {
            throw new TypeError(`expect.extend: \`${key}\` is not a valid matcher. Must be a function, is "${(0, jest_get_type_1.getType)(matcher)}"`);
        }
        Object.defineProperty(matcher, exports.INTERNAL_MATCHER_FLAG, {
            value: isInternal,
        });
        if (!isInternal) {
            // expect is defined
            class CustomMatcher extends asymmetricMatchers_1.AsymmetricMatcher {
...
const addCustomEqualityTesters = (newTesters) => {
    if (!Array.isArray(newTesters)) {
        throw new TypeError(`expect.customEqualityTesters: Must be set to an array of Testers. Was given "${(0, jest_get_type_1.getType)(newTesters)}"`);
    }
